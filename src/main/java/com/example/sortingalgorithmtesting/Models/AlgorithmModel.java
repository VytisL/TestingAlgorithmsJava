...
public class AlgorithmModel {
    ...
    private final ObservableList<String> inputList = FXCollections.observableArrayList();

    public AlgorithmModel(String algorithmName, ObservableList<String> inputList) {
